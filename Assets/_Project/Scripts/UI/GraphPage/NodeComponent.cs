...
namespace UI.DevicePage
{
    ...
    // public class NodeComponent : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    // {
    ...
    //
    //     public List<NodeComponent> linkedNodes = new();
    //
